...
const FeedBackCard = ({ content, name, title, img }) => (
  <div className="flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[350px] sm:mr-5 mr-0 my-5 feedback-card">
    ...
    <div className="flex flex-row">
      ...
      <div className="flex flex-col ml-4">
        ...
        <p className="text-dimWhite font-poppins font-normal text-[16px] leading-6">
          {title}
        </p>
      </div>
    </div>
